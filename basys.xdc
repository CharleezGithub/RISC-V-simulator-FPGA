...
set_property PACKAGE_PIN U19 [get_ports {io_led[0]}]
set_property PACKAGE_PIN V19 [get_ports {io_led[1]}]
set_property PACKAGE_PIN W18 [get_ports {io_led[2]}]
set_property PACKAGE_PIN U15 [get_ports {io_led[3]}]
set_property PACKAGE_PIN U14 [get_ports {io_led[4]}]
set_property PACKAGE_PIN V14 [get_ports {io_led[5]}]
set_property PACKAGE_PIN V13 [get_ports {io_led[6]}]
set_property PACKAGE_PIN V3  [get_ports {io_led[7]}]
set_property PACKAGE_PIN W3  [get_ports {io_led[8]}]
set_property PACKAGE_PIN U3  [get_ports {io_led[9]}]
set_property PACKAGE_PIN P3  [get_ports {io_led[10]}]
set_property PACKAGE_PIN N3  [get_ports {io_led[11]}]
...
set_property PACKAGE_PIN U18 [get_ports {io_add_stock}]
